  ...
  return (
    <div className="min-h-screen bg-white text-[#111111] font-body selection:bg-[#cc420d] selection:text-white">
      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-neutral-100 shadow-sm transition-all">
        <div className="max-w-[1366px] mx-auto px-4 sm:px-8 py-3 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center">
            <a
              ...
              className="bg-[#cc420d] hover:bg-[#b53708] text-white text-xs font-athletic-bold tracking-wider px-9 py-3 rounded-full transition-transform hover:scale-105 shadow-md shadow-orange-900/20"
            >
              INSCRÍBETE
            </a>
          </div>
          ...
          <button
            ...
            className="lg:hidden p-2 text-neutral-900 hover:text-[#cc420d]"
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden bg-white border-t border-neutral-100 px-6 py-5 flex flex-col gap-4 shadow-xl">
            <a href="#distancias" onClick={() => setMobileMenuOpen(false)} className="text-base font-athletic-bold text-neutral-800">Distancias</a>
            <a href="#precios" onClick={() => setMobileMenuOpen(false)} className="text-base font-athletic-bold text-neutral-800">Precios</a>
            <a href="#premiacion" onClick={() => setMobileMenuOpen(false)} className="text-base font-athletic-bold text-neutral-800">Premiación</a>
            <a href="#kit" onClick={() => setMobileMenuOpen(false)} className="text-base font-athletic-bold text-neutral-800">Kit</a>
            <a href="#como-llegar" onClick={() => setMobileMenuOpen(false)} className="text-base font-athletic-bold text-neutral-800">Como llegar</a>
            <a
              href={REGISTRATION_URL}
              target="_blank"
              rel="noopener noreferrer"
              className="bg-[#cc420d] text-white text-center text-xs font-athletic-bold py-3.5 rounded-full mt-2"
            >
              INSCRÍBETE
            </a>
          </div>
      ...
      {/* =========================================================================
          SECTION 01: HERO (CON PATRÓN DE PUNTOS REAL + FUENTES ITALIC IDÉNTICAS)
         ========================================================================= */}
      <section 
        id="inicio" 
      ...
      >
        <div className="max-w-[1366px] mx-auto w-full px-4 sm:px-10 py-12 lg:py-16 relative z-20">
          <div className="max-w-2xl text-white space-y-6">
            ...
            {/* Distances schedule box con números atléticos itálicos idénticos */}
            <div id="distancias" className="inline-block w-full max-w-lg rounded-2xl border-2 border-white/60 bg-black/35 backdrop-blur-sm p-4 sm:p-5 shadow-2xl">
            ...
            <div>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-white text-black hover:bg-neutral-100 font-athletic-bold text-xs sm:text-sm tracking-wider px-10 py-4 rounded-full shadow-lg transition-transform hover:scale-105"
              >
        ...
        <div className="max-w-4xl mx-auto relative z-10 space-y-4">
          ...
          <div className="pt-2">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-white text-black hover:bg-neutral-100 font-athletic-bold text-xs sm:text-sm tracking-wider px-10 py-3.5 rounded-full shadow-lg transition-transform hover:scale-105"
            >
              INSCRÍBETE AHORA
              <ArrowUpRight size={16} className="stroke-[3]" />
            </a>
      ...
      {/* =========================================================================
          SECTION 02: PREMIACIÓN ECONÓMICA (COLORES, TABLAS Y FUENTES EXACTAS)
         ========================================================================= */}
      <section 
        id="premiacion" 
        className="relative bg-cover bg-center py-20 px-4 sm:px-8 text-white overflow-hidden"
        style={{ backgroundImage: "url('/backgrounds/bg_premiacion.jpg')" }}
      >
        <div className="max-w-[1366px] mx-auto relative z-10 text-center">
          ...
          {/* 3 Real Cards con las opacidades exactas del cliente */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto text-left">
            {prizes.map((p) => (
              <div
                key={p.distance}
                style={{ backgroundColor: p.cardBg }}
                className={`rounded-3xl p-6 sm:p-8 flex flex-col justify-between shadow-2xl backdrop-blur-sm transition-transform hover:-translate-y-1.5 duration-300 ${p.textColor}`}
              >
                <div>
                  <div className={`pb-3 border-b-2 ${p.borderBottom}`}>
                    <span className="font-athletic text-6xl sm:text-7xl block">
                      {p.distance}
                    </span>
                  </div>
          ...
          <div className="mt-14">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-white text-black hover:bg-neutral-100 font-athletic-bold text-xs sm:text-sm tracking-wider px-10 py-4 rounded-full shadow-xl transition-transform hover:scale-105"
            >
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          ...
          <div className="pt-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-[#ababb2] hover:bg-neutral-400 text-neutral-950 font-athletic-bold text-xs sm:text-sm tracking-wider px-10 py-4 rounded-full transition-colors"
            >
              CORRE POR TU META. ¡INSCRÍBETE AHORA!
            </a>
          </div>
      ...
      >
        <div className="max-w-[1366px] mx-auto relative z-10 text-center">
          ...
          {/* 4 Columnas con Fondo Negro 69% Transparencia */}
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 max-w-6xl mx-auto text-left">
            
            {/* Categorías */}
            <div 
              style={{ backgroundColor: 'rgba(0, 0, 0, 0.69)' }}
              className="backdrop-blur-sm rounded-2xl p-6 border border-white/10 flex flex-col justify-between"
            >
              <div>
      ...
      >
        <div className="max-w-[1366px] mx-auto grid grid-cols-1 lg:grid-cols-12 min-h-[520px] items-stretch">
          ...
          <div className="lg:col-span-6 p-8 sm:p-12 lg:p-16 flex flex-col justify-center space-y-6">
            ...
            {/* 6 Iconos Más Grandes con Separadores Naranjas */}
            <div className="grid grid-cols-3 sm:grid-cols-6 gap-3 sm:gap-0 pt-2 pb-2">
              {kitItems.map((item, idx) => (
                ...
                >
                  ...
                  <span className="font-athletic-semibold text-xs sm:text-sm text-white/95 tracking-wide">{item.label}</span>
                </div>
              ))}
            </div>
            ...
            <div>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-white text-black hover:bg-neutral-100 font-athletic-bold text-xs sm:text-sm tracking-wider px-8 py-3.5 rounded-full shadow-lg transition-transform hover:scale-105"
              >
        ...
        <div className="max-w-[1366px] mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            <div className="lg:col-span-6 bg-white/95 backdrop-blur-md rounded-3xl p-6 border border-neutral-200 shadow-md space-y-4">
              <div className="relative aspect-[16/9] w-full rounded-2xl overflow-hidden border border-neutral-200 min-h-[220px]">
                <Image
                  src="/images/assets/img_xref_24.png"
                  alt="Mapa Estadio El Cacique"
                  fill
                  unoptimized
                  priority
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-2">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 bg-[#cc420d] hover:bg-[#b53708] text-white font-athletic-bold text-xs px-6 py-2.5 rounded-full transition-transform hover:scale-105 shadow-sm shrink-0"
                >
                  VER CÓMO LLEGAR
            ...
            <div className="lg:col-span-6 bg-[#111111]/95 text-white backdrop-blur-md rounded-3xl p-8 border border-neutral-800 shadow-xl space-y-6">
              ...
              <div className="pt-2 border-t border-neutral-800">
                ...
                <div className="grid grid-cols-4 gap-2 text-center">
                  {distances.map((d) => (
                    <div key={d.label} className="bg-neutral-900 rounded-xl p-2.5 border border-neutral-800">
        ...
        <div className="max-w-[1366px] mx-auto space-y-10">
          ...
          <div className="flex justify-center items-center gap-6">
            <a
              ...
              rel="noopener noreferrer"
              aria-label="WhatsApp"
              className="w-14 h-14 rounded-full bg-white text-black flex items-center justify-center hover:scale-110 hover:bg-[#cc420d] hover:text-white transition-all shadow-md"
            >
